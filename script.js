...
pres_sub: "Telas reais do produto: onde tudo começa e onde tudo é lembrado.",
...
pres_sub: "Real product screens: where everything starts and where everything is remembered.",
...
pres_sub: "उत्पाद की असली स्क्रीन: जहां सब शुरू होता है और जहां सब याद रहता है।",
...
pres_sub: "真实的产品截图：一切开始的地方，和一切被记住的地方。",
...
pres_sub: "実画面 2 枚：すべてが始まる場所と、すべてが記憶される場所。",
...
pres_sub: "Два настоящих экрана: место, где всё начинается, и место, где всё запоминается.",
